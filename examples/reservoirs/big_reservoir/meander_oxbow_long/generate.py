"""Long 'channel:MEANDER_OXBOW' reservoir (10 x 1 blocks — Y-flowing), uniform conditioning.
...
Raw scalars used (training mean for layer 'channel:MEANDER_OXBOW'):
    ntg                    0.4214
    width_cells            7.148
    depth_cells            6.4997
    mCHsinu                1.6251
...
RAW_SCALARS = {'ntg': 0.4214, 'width_cells': 7.148, 'depth_cells': 6.4997, 'mCHsinu': 1.6251, 'mFFCHprop': 0.0, 'probAvulInside': 0.0}
