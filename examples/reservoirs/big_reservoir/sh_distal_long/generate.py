"""Long 'channel:SH_DISTAL' reservoir (10 x 1 blocks — Y-flowing), uniform conditioning.
...
Raw scalars used (training mean for layer 'channel:SH_DISTAL'):
    ntg                    0.6197
    width_cells            11.7034
    depth_cells            6.5004
    mCHsinu                1.275
...
RAW_SCALARS = {'ntg': 0.6197, 'width_cells': 11.7034, 'depth_cells': 6.5004, 'mCHsinu': 1.275, 'mFFCHprop': 0.0999, 'probAvulInside': 0.06}
