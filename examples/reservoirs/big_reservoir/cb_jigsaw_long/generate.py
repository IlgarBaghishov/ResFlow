"""Long 'channel:CB_JIGSAW' reservoir (10 x 1 blocks — Y-flowing), uniform conditioning.
...
Raw scalars used (training mean for layer 'channel:CB_JIGSAW'):
    ntg                    0.3854
    width_cells            11.0462
    depth_cells            6.499
    mCHsinu                1.2499
...
RAW_SCALARS = {'ntg': 0.3854, 'width_cells': 11.0462, 'depth_cells': 6.499, 'mCHsinu': 1.2499, 'mFFCHprop': 0.3999, 'probAvulInside': 0.375}
