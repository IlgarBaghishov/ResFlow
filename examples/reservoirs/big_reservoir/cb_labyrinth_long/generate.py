"""Long 'channel:CB_LABYRINTH' reservoir (10 x 1 blocks — Y-flowing), uniform conditioning.
...
Raw scalars used (training mean for layer 'channel:CB_LABYRINTH'):
    ntg                    0.3693
    width_cells            10.3977
    depth_cells            6.4987
    mCHsinu                1.2751
...
RAW_SCALARS = {'ntg': 0.3693, 'width_cells': 10.3977, 'depth_cells': 6.4987, 'mCHsinu': 1.2751, 'mFFCHprop': 0.325, 'probAvulInside': 0.06}
