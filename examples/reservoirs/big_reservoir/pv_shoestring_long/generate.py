"""Long 'channel:PV_SHOESTRING' reservoir (10 x 1 blocks — Y-flowing), uniform conditioning.
...
Raw scalars used (training mean for layer 'channel:PV_SHOESTRING'):
    ntg                    0.2288
    width_cells            7.1494
    depth_cells            6.5011
    mCHsinu                1.5752
...
RAW_SCALARS = {'ntg': 0.2288, 'width_cells': 7.1494, 'depth_cells': 6.5011, 'mCHsinu': 1.5752, 'mFFCHprop': 0.1501, 'probAvulInside': 0.06}
